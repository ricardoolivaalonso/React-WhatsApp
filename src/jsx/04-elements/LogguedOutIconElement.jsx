...
const LogguedOutIconElement = () => {
    const { setUid, setEmail, setMessages } = useContext(ChatContext)
    ...
    return(
        <a onClick={LogguedOut} title='Cerrar sesión'>
